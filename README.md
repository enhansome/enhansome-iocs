...
An [awesome](https://github.com/sindresorhus/awesome) ⭐ 498,211 | 🐛 105 | 📅 2026-08-18 collection of indicators of compromise (and a few IOC related tools).
...
* [Neo23x0/signature-base](https://github.com/Neo23x0/signature-base) ⭐ 3,009 | 🐛 13 | 🌐 YARA | 📅 2026-08-03 - Signature base for my scanner tools.
...
* [Yara-Rules/rules](https://github.com/Yara-Rules/rules) ⭐ 4,875 | 🐛 28 | 🌐 YARA | 📅 2024-04-17 - Repository of yara rules.
...
* [ninoseki/mitaka](https://github.com/ninoseki/mitaka#downloads) ⭐ 1,841 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-20 - Browser extension to lookup IoCs/observables on many sources.
