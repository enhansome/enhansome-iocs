...
An [awesome](https://github.com/sindresorhus/awesome) ⭐ 504,851 | 🐛 106 | 📅 2026-09-02 collection of indicators of compromise (and a few IOC related tools).
...
* [Neo23x0/signature-base](https://github.com/Neo23x0/signature-base) ⭐ 3,024 | 🐛 14 | 🌐 YARA | 📅 2026-09-08 - Signature base for my scanner tools.
...
* [Yara-Rules/rules](https://github.com/Yara-Rules/rules) ⭐ 4,892 | 🐛 27 | 🌐 YARA | 📅 2024-04-17 - Repository of yara rules.
...
* [ninoseki/mitaka](https://github.com/ninoseki/mitaka#downloads) ⭐ 1,853 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-10 - Browser extension to lookup IoCs/observables on many sources.
* [Neo23x0/yarGen](https://github.com/Neo23x0/yarGen) ⭐ 1,814 | 🐛 15 | 🌐 Python | 📅 2026-01-10 - yarGen is a generator for YARA rules.
