...
An [awesome](https://github.com/sindresorhus/awesome) ⭐ 506,395 | 🐛 106 | 📅 2026-09-02 collection of indicators of compromise (and a few IOC related tools).
...
* [reversinglabs/reversinglabs-yara-rules](https://github.com/reversinglabs/reversinglabs-yara-rules) ⭐ 942 | 🐛 2 | 🌐 YARA | 📅 2025-11-03 - ReversingLabs YARA Rules.
...
* [ninoseki/mitaka](https://github.com/ninoseki/mitaka#downloads) ⭐ 1,857 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-10 - Browser extension to lookup IoCs/observables on many sources.
