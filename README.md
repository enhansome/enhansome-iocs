...
An [awesome](https://github.com/sindresorhus/awesome) ⭐ 505,761 | 🐛 106 | 📅 2026-09-02 collection of indicators of compromise (and a few IOC related tools).
...
* [Neo23x0/signature-base](https://github.com/Neo23x0/signature-base) ⭐ 3,026 | 🐛 17 | 🌐 YARA | 📅 2026-09-08 - Signature base for my scanner tools.
...
* [ninoseki/mitaka](https://github.com/ninoseki/mitaka#downloads) ⭐ 1,855 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-10 - Browser extension to lookup IoCs/observables on many sources.
